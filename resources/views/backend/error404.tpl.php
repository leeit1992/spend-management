...
<head>
    ...
    <!-- uikit -->
    <link rel="stylesheet" href="<?php echo assets( 'backend/bower_components/uikit/css/uikit.almost-flat.min.css' ); ?>"/>

    <!-- altair admin error page -->
    <link rel="stylesheet" href="<?php echo assets( 'backend/assets/css/error_page.min.css' ); ?>" />
